...
const TRANSLATIONS = {
  ...
  'news.2.desc': { zh: '百余位宗亲齐聚下枫槎，共祭先祖。今年新增了年轻一代主祭环节，传承家族文化。', en: 'Over a hundred relatives gathered at Xiafengcha to honor their ancestors. This year, younger family members led part of the ceremony, carrying the family tradition forward.' },
...
const EXTRA_TRANSLATIONS = {
  ...
  '语音朗读': 'Read aloud',
  '全面展示出继 / 入继关系': 'Show adoption and inheritance relationships',
  '暂无数据': 'No data available',
  '搜索姓名...': 'Search name...',
  '没有找到匹配的族人': 'No matching family members found',
  '地图加载失败，请检查网络后刷新页面': 'Map failed to load. Please check your network and refresh the page.',
  '谢邑': 'Xie Yi',
  '东山会稽': 'Dongshan Kuaiji',
  '临海下渡': 'Linhai Xiadu',
  '石马（下谢）': 'Shima (Lower Xie)',
  '岩下': 'Yanxia',
  '下枫槎村': 'Xiafengcha Village',
  '周代': 'Zhou Dynasty',
  '六朝': 'Six Dynasties',
  ...
  '明代': 'Ming Dynasty',
  '1572年': '1572',
  '周宣王封申伯于谢邑，谢氏得姓': 'King Xuan of Zhou granted Shenbo the fief of Xie Yi, and the Xie family took its surname from that place.',
  '传36世，乌衣巷王谢世家': 'Thirty-six generations later, the Wang and Xie clans of Black-Clad Lane were celebrated families.',
  '谢氏一支从会稽南下经临海古渡口入台州': 'A branch of the Xie family traveled south from Kuaiji through the ancient Linhai ferry into Taizhou.',
  '小四公（谢聪孙）从临海迁入石马，为入浙东近祖': 'Xiao Sigong (grandson of Xie Cong) moved from Linhai to Shima and became a recent ancestor of the Xie family in eastern Zhejiang.',
  '文杲公始迁岩下，枫槎谢氏始迁祖': 'Wen Gao Gong first moved to Yanxia and became the founding migrant ancestor of the Xie family of Fengcha.',
  '乾公彬公因水患迁居，开基立业': 'Brothers Qian and Bin moved after a flood and established the family settlement.',
  '加载世系图中…': 'Loading lineage chart…',
  '暂无族谱数据，请在管理后台添加': 'No genealogy data available. Add records in the Admin Console.',
  '暂无显示数据': 'No data to display',
  '✕ 可读': '✕ Readable',
  '支系总人口': 'Branch population',
  '该支系暂无详细的世代连接数据': 'This branch has no detailed generational connection data yet.',
  '请在管理后台补充父ID关联后，即可查看完整世系图': 'Add parent ID links in the Admin Console to view the complete lineage chart.',
  '搜索中...': 'Searching...',
  '未找到': 'Not found',
  '请输入两人姓名': 'Enter two names',
  '是同一个人': 'The same person',
  '夫妻关系': 'Spousal relationship',
  '未找到共同祖先': 'No common ancestor found',
  '横屏显示中': 'Landscape mode active',
  '（点击图片缩放）': '(Click the image to zoom)',
  '手机号码': 'Mobile number',
  '手机号': 'Mobile phone',
  '收起/展开左侧总导航': 'Collapse/expand main navigation',
  '收起/展开后台模块导航': 'Collapse/expand admin navigation',
  '▶ 总导航': '▶ Main navigation',
  '◀ 总导航': '◀ Main navigation',
  '▶ 后台菜单': '▶ Admin menu',
  '◀ 后台菜单': '◀ Admin menu',
  '请输入管理员手机号': 'Enter administrator mobile number',
  '正在验证手机号…': 'Verifying mobile number…',
  '手机号验证失败': 'Mobile-number verification failed',
  '密码错误，请重试': 'Incorrect password. Please try again.',
  '无法连接服务器，请检查网络后重试': 'Unable to connect to the server. Check the network and try again.',
  '或使用管理员手机号快捷进入': 'Or enter quickly with the administrator mobile number',
  '手机号快捷登录': 'Quick sign-in with mobile',
  '族谱管理': 'Genealogy management',
  '世代数': 'Generation number',
  '始祖为1，依次递增': 'The founding ancestor is generation 1; increase sequentially',
  '姓名': 'Name',
  '性别': 'Gender',
  '是': 'Yes',
  '男': 'Male',
  '女': 'Female',
  '字号': 'Generation character',
  '如：字成欢': 'e.g. generation character Chenghuan',
  '父亲ID': 'Father ID',
  '填写父亲的编号，始祖留空': 'Enter the father ID; leave blank for the founding ancestor',
  '母亲ID': 'Mother ID',
  '填写母亲的编号': 'Enter the mother ID',
  '配偶': 'Spouse',
  '直接输入姓名，多个用逗号分隔': 'Enter names directly, separated by commas',
  '是否过继': 'Adoption status',
  '否': 'No',
  '是(嗣子)': 'Yes (heir son)',
  '是(继子)': 'Yes (adoptive son)',
  '是(养子)': 'Yes (adopted son)',
  '生父ID（嗣子填写，显示原生 lineage）': 'Biological father ID (for heir sons; shows the original lineage)',
  '嗣子的亲生父亲ID': 'Biological father ID of the heir son',
  '生母ID': 'Biological mother ID',
  '嗣子的亲生母亲ID': 'Biological mother ID of the heir son',
  '支系': 'Branch',
  '长房': 'First branch',
  '如: 1950 或 1950-03-15': 'e.g. 1950 or 1950-03-15',
  '出生': 'Birth',
  '逝世': 'Death',
  '在世则留空': 'Leave blank if living',
  '是否在世': 'Living status',
  '居住地': 'Residence',
  '生平简介': 'Biography',
  '照片': 'Photo',
  ...
  '家族事务': 'Family affairs',
  '通知公告': 'Notices',
  '网站公告': 'Website notices',
  '节日祝福': 'Holiday greetings',
  '发布日期': 'Publication date',
  '发布人': 'Published by',
  '原文链接': 'Source link',
  '选填，如有外部原文可粘贴网址': 'Optional; paste an external source URL if available',
  '消息内容': 'News content',
  '相关链接': 'Related link',
  '可粘贴相关报道或资料链接（选填）': 'Optional; paste a related report or record link',
  '颁发单位': 'Awarding organization',
  '获得日期': 'Date received',
  '荣誉名称': 'Honor name',
  '同步中…': 'Syncing…',
  '✅ 已同步': '✅ Synced',
  '同步失败，数据在本地安全': 'Sync failed; the data is safe locally',
  '有未同步的数据': 'Unsynced data available',
  '数据保护': 'Data protection',
  '手动备份': 'Manual backup',
  '导出JSON': 'Export JSON',
  '正在备份': 'Backing up',
  '已导出': 'Exported',
  '填写更新说明': 'Enter the update description',
  '版本': 'Version',
  '已记录': 'recorded',
  '确定删除此版本记录？': 'Delete this version record?',
  '访客信息': 'Visitor information',
  '加载中...': 'Loading...',
  '暂无访客记录': 'No visitor records',
  '类型': 'Type',
  '时间': 'Time',
  ...
  '新增': 'Add',
  '操作': 'Actions',
  '编辑此人': 'Edit this person',
  '添加子女': 'Add child',
  '删除此人': 'Delete this person',
  '确定删除': 'Confirm deletion of',
  '无后代记录': 'No descendant records',
  '后裔已收进右下角框，点击可缩放查看': 'Descendants are in the lower-right panel; click to zoom',
  '保存': 'Save',
  '如：文、明、光等': 'e.g. Wen, Ming or Guang',
  '微信号码': 'WeChat ID',
  '如：寻根、研究、参观等': 'e.g. genealogy search, research or visiting',
  '✅ 提交族人登记': '✅ Submit family-member registration',
  '👤 提交访客登记': '👤 Submit visitor registration',
  '请输入姓名': 'Enter a name',
  '✅ 登记成功！感谢您的登记！': '✅ Registration successful! Thank you!',
  '方便我们回复您': 'So we can reply to you',
  '请详细描述您的需求或建议...': 'Please describe your request or suggestion...',
  '网站栏目导航': 'Website section navigation',
  ...
  '信息仅用于宗祠联络，不会公开': 'This information is used only for ancestral-hall contact and will not be public.',
  '下枫槎谢氏 · 族人': 'Xie Family of Xiafengcha · Family member',
  '下枫槎村 · 访客': 'Xiafengcha Village · Visitor',
  '📥 导出族谱': '📥 Export genealogy',
  '每格一代 · 柱高=人丁 · 点击柱子查看该世族人 · 右上角「全屏」可缩放': 'One column per generation · Height shows population · Click a column to view that generation · Use “Fullscreen” at the top right to zoom',
  '出继': 'adopted out',
  '入继': 'adopted in',
  '您': 'You',
  '请先填写要查询的族人姓名': 'Please enter a family member name to search',
  '继父（承嗣父） · 血缘0%': 'Adoptive father · 0% blood relation',
  '树状世系图': 'Lineage tree',
  ...
  '上代数据不完整': 'Previous-generation data is incomplete',
  '过继线': 'Adoption line',
  '原生线（生父系）': 'Biological line (father’s line)',
  '上代直系': 'Direct ancestors',
  '点击查看详情': 'View details',
  '父母': 'Parents',
  '子女': 'Children',
  '暂无记录': 'No records',
  '您本人': 'You',
  '亲生父子 · 血缘50%': 'Biological father and son · 50% blood relation',
  '基因共享率：最高 50%（父母/子女/亲兄弟姐妹），越高越亲': 'Shared DNA: up to 50% for parents, children and full siblings; the higher the percentage, the closer the relationship',
  '手机号访问登记不等同于族人身份核验；敏感族谱信息仍需族人三代信息核验。': 'Mobile-number registration does not verify family-member identity; sensitive genealogy information still requires three-generation family-member verification.',
  '谢伟中': 'Xie Weizhong',
  '谢兴隆': 'Xie Xinglong',
  '展开': 'Expand',
  '收起': 'Collapse',
  '展开 ▾': 'Expand ▾',
  '收起 ▴': 'Collapse ▴',
  '暂无生平记载': 'No biographical record',
  '修谱功德': 'Genealogy contribution',
  '族人筹款': 'Family fundraising',
  '外来宗亲助款': 'Contributions from visiting relatives',
  '社会各界助款': 'Contributions from the wider community',
  '宗祠修缮': 'Ancestral hall restoration',
  '未登记': 'Not registered',
  '您尚未登记': 'You have not registered',
  '📋 欢迎登记': '📋 Welcome to register',
  '登记后即可查看个人信息': 'View your personal information after registering',
  '📋 立即登记': '📋 Register now',
  '信息不符，请核对或联系管理员': 'The information does not match. Please check or contact an administrator.',
  '网络异常，请重试': 'Network error. Please try again.',
  '✦ 收起': '✦ Collapse',
  '是，我是族人': 'Yes, I am a family member',
  '不是': 'No',
  '欢迎族人！请填写基本信息': 'Welcome, family member! Please enter your basic information.',
  '暂不验证，先浏览': 'Skip verification and browse',
  '欢迎您！请问您访问本站的目的是？': 'Welcome! What brings you to this site?',
  '或使用以下方式登录': 'Or sign in using one of the methods below',
  '💬 微信': '💬 WeChat',
  '📞 电话': '📞 Phone',
  ...
  '分支': 'Branch',
  '安全访问族谱': 'Secure genealogy access',
  '欢迎访问下枫槎谢氏数字宗谱。本网站包含家族世系、历史资料及部分近现代族人信息。': 'Welcome to the Xiafengcha Xie family digital genealogy. This site contains family lineages, historical records and selected information about modern and contemporary family members.',
  '隐私保护说明': 'Privacy protection notice',
  '点击展开完整说明': 'Click to expand the full notice',
  '为保护族谱资料及族人隐私，本网站将根据您的选择收集必要的登录信息，用于身份认证、访问权限管理和族谱服务。': 'To protect genealogy records and family privacy, this site collects only the login information needed for identity verification, access control and genealogy services.',
  '族谱中的历史资料、世系关系等信息仅用于文化传承与查询，不得擅自复制、传播、商业使用或用于其他用途。对于在世族人的出生日期、联系方式、居住地等个人信息，网站将进行权限控制，未经本人或管理授权不会公开展示。': 'Historical records and lineage information in the genealogy are for cultural preservation and search only. They may not be copied, distributed, used commercially or used for other purposes without permission. Access to personal information about living family members, such as birth dates, contact details and residences, is controlled and is not displayed without authorization.',
  '您可以选择“族人”或“普通访客”身份访问。族人身份需要经过核验，普通访客无需提交族谱内部信息。您可以申请查询、更正或删除与本人相关的信息。': 'You may visit as a family member or a public visitor. Family-member access requires verification; public visitors do not need to submit internal genealogy information. You may request access to, correction of or deletion of information about yourself.',
  '点击“同意并继续”，表示您已阅读并同意本说明；点击“不同意”，将退出登录流程。': 'Click “Agree and continue” to confirm that you have read and accepted this notice. Click “Decline” to leave the sign-in process.',
  '不同意': 'Decline',
  '同意并继续': 'Agree and continue',
  '上一步': 'Previous step',
  '确认进入': 'Confirm and enter',
  '请选择您的访问身份。管理员仅限登记手机号登录；族人需要完成三代信息核验；普通访客只浏览公开内容。': 'Please choose your access role. Administrators must use the registered mobile number; family members must verify three generations; public visitors can browse public content only.',
  '我是族人': 'I am a family member',
  '登录后核验本人、父亲和祖父姓名。': 'After signing in, verify your name, your father’s name and your grandfather’s name.',
  '普通访客': 'Public visitor',
  '手机号登记后浏览公开内容。': 'Register a mobile number to browse public content.',
  '管理员': 'Administrator',
  '仅登记管理员手机号可进入，拥有全部页面和 AI 咨询权限。': 'Only the registered administrator mobile number can enter and use all pages and AI consultation.',
  '登录方式': 'Sign-in method',
  '手机号登录': 'Sign in with mobile',
  '微信登录': 'Sign in with WeChat',
  '微信登录需服务器配置官方授权参数；未配置时不会虚假放行。': 'WeChat sign-in requires official authorization settings on the server; access is never granted without them.',
  '管理员是唯一可访问后台、全部族谱页面并使用 AI 全部咨询能力的身份。': 'Administrators are the only users who can access the Admin Console, all genealogy pages and full AI consultation.',
  '管理员手机号': 'Administrator mobile number',
  '返回身份选择': 'Back to role selection',
  '当前登录方式：': 'Current sign-in method: ',
  '管理员手机号由服务器安全校验，页面不会保存明文手机号。': 'The server securely verifies the administrator mobile number; the page does not store it in plain text.',
  '普通访客登录后仅可浏览公开的村史、公开世系和公开查询内容。': 'Public visitors can browse only the public village history, public lineages and public search content after signing in.',
  '请填写三项信息，系统将与族谱管理后台的唯一主数据逐项匹配。': 'Enter the three items of information. The system will match each item against the genealogy Admin Console’s authoritative records.',
  '本人姓名': 'Your name',
  '祖父姓名': 'Grandfather’s name',
  '登录方式：': 'Sign-in method: ',
  '登录方式与族谱三代信息核验同时记录；核验结果以管理后台主数据为准。': 'The sign-in method and three-generation genealogy verification are recorded together; the Admin Console’s authoritative records determine the result.',
  '您已选择不同意，本次不会提交身份信息，也不能进入网站。': 'You declined. No identity information will be submitted and you cannot enter the site.',
  '重新确认': 'Review consent again',
  '身份确认已保存到当前手机浏览器，今后进入网站和点击族谱查询都无需重复验证；本机信任有效期为一年。': 'Your identity confirmation is saved in this mobile browser. You will not need to verify again when entering the site or opening Genealogy; this device remains trusted for one year.',
  '本次管理员会话已建立，关闭浏览器后可能需要重新验证。': 'This administrator session is active. You may need to verify again after closing the browser.',
  '管理员身份验证通过，全部页面和 AI 咨询权限已开启。': 'Administrator verification passed. All pages and AI consultation are now available.',
  '族人身份核验通过，欢迎回家。': 'Family-member verification passed. Welcome home.',
  '普通访客登录成功。': 'Public visitor sign-in successful.',
  '开始浏览': 'Start browsing',
  '退出本机信任': 'Remove device trust',
  '请输入有效的11位手机号': 'Enter a valid 11-digit mobile number',
  '正在核验管理员手机号…': 'Verifying the administrator mobile number…',
  '管理员手机号核验失败': 'Administrator mobile-number verification failed',
  '正在建立访客登录会话…': 'Starting the visitor session…',
  '登录失败，请重试': 'Sign-in failed. Please try again.',
  '请完整填写本人、父亲和祖父姓名': 'Enter your name, your father’s name and your grandfather’s name.',
  '正在与族谱管理后台主数据核对…': 'Checking against the authoritative genealogy records…',
  '信息不匹配，请核对姓名': 'The information does not match. Please check the names.',
  '网络错误，请重试': 'Network error. Please try again.',
  '已选择微信登录；服务器配置官方授权参数后将进入微信授权。': 'WeChat sign-in selected. WeChat authorization will begin once the server is configured.',
  '已选择手机号登录；族人仍需完成三代信息核验。': 'Mobile sign-in selected. Family members must still verify three generations.',
  '当前服务器尚未配置微信 OAuth 参数，请改用手机号登录。': 'This server has not configured WeChat OAuth. Please use mobile sign-in instead.',
  '微信登录服务状态暂时无法读取。': 'The WeChat sign-in service status is temporarily unavailable.',
  '请先完成隐私确认和身份核验，才能进入网站。': 'Complete privacy consent and identity verification before entering the site.',
  '服务暂不可用': 'The service is temporarily unavailable',
  '手机号未登记': 'This mobile number is not registered',
  '请改用手机号登录': 'Please use mobile sign-in instead',
  '上一段行程：约 ': 'Previous leg: about ',
  '下一段行程：约 ': 'Next leg: about ',
  '公里': 'km',
  '享年': 'lived ',
  '未找到匹配记录': 'No matching records found',
  '世系图尚未加载': 'The lineage chart has not loaded yet',
  '无数据可导出': 'No data to export',
  '↕ 纵向': '↕ Vertical',
  '↔ 横向': '↔ Horizontal',
  '⏳ 渲染世系图中...': '⏳ Rendering lineage chart...',
...
const GENERATED_PAGE_TRANSLATIONS = {
  ...
  "📋 访客登记": "📋 Visitor registration",
  "欢迎来到下枫槎村数字宗祠": "Welcome to the Xiafengcha Village Digital Ancestral Hall",
  "您是否是下枫槎谢氏族人？": "Are you a member of the Xia Fengcha clan?",
  "✅ 是，我是族人": "✅ Yes, I am a family member",
  "👤 访客参观": "👤 Visitor access",
  "姓名 *": "Name *",
  "字辈 / 世代": "Generation character / generation",
  "父亲姓名": "Father's name",
  "所属分支": "Branch",
  "请选择": "Please select",
  "大房": "First branch",
...
const GENERATED_RUNTIME_TRANSLATIONS = {
  ...
  "枫槎始祖": "Founding ancestor of Fengcha",
...
function translateString(value, lang) {
  ...
  output = output
    .replace(/（\s*全部\s*(\d+)\s*人）/g, '(all $1 people)')
    .replace(/享年\s*(\d+)\s*岁/g, 'lived $1 years')
    .replace(/(\d+(?:\.\d+)?)\s*公里/g, '$1 km')
    .replace(/(上一段行程|下一段行程)：约\s*(\d+(?:\.\d+)?)\s*公里/g, function (_, label, distance) {
      return (label === '上一段行程' ? 'Previous leg' : 'Next leg') + ': about ' + distance + ' km';
    })
    .replace(/(节点\s*\d+\s*:\s*)(谢邑|岩下)/g, function (_, prefix, name) {
      return prefix + (name === '谢邑' ? 'Xie Yi' : 'Yanxia');
    })
    .replace(/相差\s*(\d+)\s*代/g, 'Difference: $1 generations')
    .replace(/节点\s*(\d+)/g, 'Node $1')
...
const RECORD_TRANSLATIONS = {
  ...
  // Used only for person/name-like fields when a dedicated English name is not available.
  // The map is deliberately local so unknown Chinese prose still uses the explicit review marker.
  const PERSON_NAME_PINYIN = {
  "丁": "ding",
  "万": "wan",
  "三": "san",
  "下": "xia",
  ...
  function romanizeChineseName(value) {
    ...
    for (var i = 0; i < chars.length; i++) {
      var ch = chars[i];
      if (PERSON_NAME_PINYIN[ch]) parts.push(PERSON_NAME_PINYIN[ch]);
      else if (cjk.test(ch)) return '';
      else if (!/[\s·'-]/.test(ch)) return '';
    }
    if (!parts.length) return '';
    var surname = parts.shift();
    var result = surname.charAt(0).toUpperCase() + surname.slice(1);
    if (parts.length) {
      var given = parts.join('');
      result += ' ' + given.charAt(0).toUpperCase() + given.slice(1);
    }
    return result;
  }
...
function englishPersonName(person, fallback) {
  ...
  var romanized = romanizeChineseName(name);
...
function translateTextNode(node, lang) {
  ...
  if (lang === 'en') {
    ...
    else if (node.__xieTranslatedText !== node.nodeValue) {
      // Dynamic UI code often replaces textContent after the first translation
      // pass. Treat that new value as the fresh source instead of translating
      // the previous English result again.
      node.__xieOriginalText = node.nodeValue;
    }
    var next = translateString(node.__xieOriginalText, lang);
    if (next !== node.nodeValue) node.nodeValue = next;
    node.__xieTranslatedText = next;
  } else if (node.__xieOriginalText !== undefined) {
    node.nodeValue = node.__xieOriginalText;
    delete node.__xieOriginalText;
    delete node.__xieTranslatedText;
  }
}
...
function translateElementAttributes(el, lang) {
  ...
  ['title', 'aria-label', 'placeholder', 'alt'].forEach(function(attr) {
    ...
    if (!el.__xieTranslatedAttrs) el.__xieTranslatedAttrs = {};
    var current = el.getAttribute(attr);
    if (lang === 'en') {
      if (el.__xieOriginalAttrs[attr] === undefined) el.__xieOriginalAttrs[attr] = current;
      else if (el.__xieTranslatedAttrs[attr] !== undefined && el.__xieTranslatedAttrs[attr] !== current) {
        // Dynamic pages often replace a placeholder/title/aria-label after
        // the first render. Treat that replacement as fresh source text.
        el.__xieOriginalAttrs[attr] = current;
      }
      var next = translateString(el.__xieOriginalAttrs[attr], lang);
      if (next !== current) el.setAttribute(attr, next);
      el.__xieTranslatedAttrs[attr] = next;
    } else {
      var original = el.__xieOriginalAttrs[attr] !== undefined ? el.__xieOriginalAttrs[attr] : current;
      if (original !== current) el.setAttribute(attr, original);
      delete el.__xieOriginalAttrs[attr];
      delete el.__xieTranslatedAttrs[attr];
    }
  });
}
...
function startLanguageObserver() {
  ...
  languageObserver = new MutationObserver(function(records) {
    ...
    document.querySelectorAll('#lang-toggle, .language-toggle').forEach(function(toggle) {
      ...
      records.forEach(function(record) {
        if (record.type === 'attributes' && record.target && record.attributeName) {
          translateElementAttributes(record.target, 'en');
        }
        if (record.type === 'characterData' && record.target) {
          translateTextNode(record.target, 'en');
        }
  ...
  languageObserver.observe(document.body || document.documentElement, {
    childList: true,
    subtree: true,
    characterData: true,
    attributes: true,
...
function ensureLanguageToggle() {
  ...
  if (canonical && canonical.id === 'site-language-toggle' && !document.getElementById('site-language-dock')) {
    ...
    var appWorkspace = appShell && Array.prototype.slice.call(appShell.children).filter(function(child) {
      return child.classList && child.classList.contains('workspace');
    })[0];
    if (appShell && appWorkspace) {
      // The genealogy query drawer is an absolute overlay inside .tree-area.
      // Keep the language row outside that stacking context so it cannot cover
      // the first title or leave a clipped blank band above query content.
      dock.classList.add('site-language-dock--app-shell');
      appShell.insertBefore(dock, appWorkspace);
    } else if (openingTopRight) {
