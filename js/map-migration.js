...
(function () {
  ...
  var ROUTE = [
    ...
    { lng: 121.219, lat: 28.865, name: '临海下渡',   fullName: '浙江台州·临海市邵家渡街道下渡村', year: '唐末',    era: '唐末', desc: '谢氏一支从会稽南下经临海古渡口入台州' },
    { lng: 121.290, lat: 29.065, name: '石马（下谢）', fullName: '浙江台州·三门县珠岙镇石马村', year: '北宋初',  era: '北宋', desc: '小四公（谢聪孙）从临海迁入石马，为入浙东近祖' },
    { lng: 121.445, lat: 29.253, name: '岩下',       fullName: '浙江宁波·宁海县跃龙街道岩头下村', year: '约1125年', era: '北宋', desc: '文杲公始迁岩下，枫槎谢氏始迁祖' },
    { lng: 121.452, lat: 29.248, name: '下枫槎村',   fullName: '浙江宁波·宁海县跃龙街道望府村',  year: '1572年',  era: '明代', desc: '乾公彬公因水患迁居，开基立业' }
  ];
