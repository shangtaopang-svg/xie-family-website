...
function renderGenealogy(area) {
  ...
  html += buildAdminTreeHtml(allData);
  html += '</div>';
  html += '</div>';
  html += '</div>';
...
function getAllAncientData() {
  var raw = [
    ...
    [85,'翠','平利之子','平利'],[85,'利','平利之子','平利'],[85,'文','平和之子','平和'],
    ...
    // 东山世系 — 炎帝100→121
    [100,'衡','会稽东山始祖','缵'],
    [100,'鲲','衡之子','衡'],[100,'裒','衡之子，谢安之父','衡'],[100,'广','衡之子','衡'],
    [101,'奕','裒之子','裒'],[101,'据','裒之子','裒'],
    [101,'安','字安石，东晋名相','裒'],[101,'万','裒之子','裒'],[101,'淮','裒之子','裒'],[101,'石','裒之子','裒'],[101,'铁','裒之子','裒'],
    [102,'瑶','安之子','安'],[102,'琰','安之子','安'],
    [103,'肇','琰之子','琰'],[103,'峻','琰之子','琰'],[103,'混','琰之子','琰'],
    [104,'密','混之子','混'],[105,'庄','密之子','密'],
    [106,'飏','庄之子','庄'],[106,'胜','庄之子','庄'],[106,'灏','庄之子','庄'],[106,'丛','庄之子','庄'],[106,'沦','庄之子','庄'],
    [107,'览','飏之子','飏'],[108,'琢','览之子','览'],[108,'侨','览之子','览'],
    [109,'琂','琢之子','琢'],[109,'琬','琢之子','琢'],
    [110,'峤','琂之子','琂'],[110,'植','琂之子','琂'],
    [111,'钝','植之子','植'],[111,'缪','植之子','植'],
    [112,'修','钝之子','钝'],[112,'豹','钝之子','钝'],
    [113,'恺','修之子','修'],
    [114,'骢','恺之子','恺'],[114,'驼','恺之子','恺'],[114,'绰','恺之子','恺'],
    [115,'式','绰之子','绰'],[116,'革','式之子','式'],[116,'造','式之子','式'],
    [117,'直','造之子','造'],[118,'是温','直之子','直'],
    [119,'翳','是温之子','是温'],[120,'静','翳之子','翳'],[120,'观','翳之子','翳'],
    // 闓 → 连接东山与临海下渡
    [121,'闓','观之子/临海下渡第一世','观'],

    // 临海下渡世系 — 炎帝122→129
    [122,'俨','闓之子','闓'],[123,'诜','俨之子','俨'],
    [124,'景之','诜之子','诜'],[124,'考之','诜之子','诜'],
    [125,'润甫','景之之后','景之'],[125,'深甫','景之之后','景之'],
    ...
    [131,'文杲','丹一之后，枫槎谢氏始迁祖','丹一'],[131,'文榘','丹一之后，东门桃源陈氏之祖','丹一'],
    [131,'丹九','丹三之后','丹三'],
  ...
  // Convert 4-element arrays [gen, name, note, parent] to 5-element [gen, 0, name, note, parent]
  return _rawToData(raw.map(function(r) { if (r.length < 5) r.splice(1, 0, 0); return r; }), 50000, '古世系');
}
